...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create a stunning thumbnails that get clicks, without the hassle." />
            <div className="grid grid-cols-3 items-center justify-center gap-6 md:gap-4 mt-16 px-6">
